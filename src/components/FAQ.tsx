  ...
  const faqData = [
    {
      ...
      icon: Package,
      color: isPremium ? 'from-blue-500 to-cyan-500' : 'from-blue-500 to-blue-600',
      items: [
        {
    ...
    },
    {
      ...
      icon: Mail,
      color: isPremium ? 'from-green-500 to-emerald-500' : 'from-green-500 to-green-600',
      items: [
        {
    ...
    },
    {
      ...
      icon: BarChart3,
      color: isPremium ? 'from-purple-500 to-violet-500' : 'from-purple-500 to-purple-600',
      items: [
        {
    ...
    },
    {
      ...
      icon: CreditCard,
      color: isPremium ? 'from-orange-500 to-amber-500' : 'from-orange-500 to-orange-600',
      items: [
        {
    ...
    },
    {
      ...
      icon: Shield,
      color: isPremium ? 'from-red-500 to-pink-500' : 'from-red-500 to-red-600',
      items: [
        {
    ...
    },
    {
      ...
      icon: DollarSign,
      color: isPremium ? 'from-teal-500 to-cyan-500' : 'from-teal-500 to-teal-600',
      items: [
        {
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-4">
            <div className={`
              ...
              ${isPremium 
                ? 'bg-gradient-to-r from-purple-600 to-blue-600 glow-purple' 
                ...
                {category.items.map((item, itemIndex) => {
                  ...
                  return (
                    <div key={itemIndex}>
                      ...
                      {isOpen && (
                        <div className="px-6 pb-4 animate-in fade-in slide-in-from-bottom-4">
                          <div className={`
        ...
        <div className="mt-12 text-center">
          ...
          `}>
            <div className="flex items-center justify-center mb-4">
              <Sparkles className={`
                w-6 h-6 mr-2
                ${isPremium ? 'text-purple-400' : 'text-blue-500'}
              `} />
              <h3 className={`
                text-xl font-semibold
                ${isPremium ? 'text-white' : 'text-gray-900'}
            ...
            `}>
              Our support team is here to help you get the most out of Resell Dashboard.
            </p>
