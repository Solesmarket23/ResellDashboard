          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="bg-purple-900/20 border border-purple-500/30 text-purple-400 px-3 py-2 rounded-lg text-sm hover:bg-purple-900/30 transition-colors flex items-center gap-2"
              >
