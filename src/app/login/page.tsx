...
function LoginForm() {
  ...
  const handleEmailAuth = async (e: React.FormEvent) => {
    ...
    const timeoutDuration = 20; // 20 seconds
  ...
  const handleGoogleSignIn = async () => {
    ...
    // Start timeout countdown for Google sign-in
    const timeoutDuration = 30; // 30 seconds for Google
    setTimeoutCountdown(timeoutDuration);
            ...
            >
              {(loading || isLoading) ? (
                <span className="flex items-center justify-center">
                  ...
                  {timeoutCountdown ? `Processing... (${timeoutCountdown}s)` : 'Processing...'}
                </span>
              ) : (
            ...
            >
              {loading || isLoading ? (
                <span className="flex items-center">
                  ...
                  {timeoutCountdown ? `Connecting... (${timeoutCountdown}s)` : 'Connecting...'}
                </span>
              ) : (
                <>
