    ...
    for (const p of products) {
      ...
      batch.set(
        ref,
        {
          ...
          currentFlexAsk: normalizeNumber(p.currentFlexAsk, undefined),
          targetAskPrice: normalizeNumber(p.targetAskPrice, undefined),
          targetFlexAskPrice: normalizeNumber(p.targetFlexAskPrice, undefined),
          targetBidPrice: normalizeNumber(p.targetBidPrice, undefined),
