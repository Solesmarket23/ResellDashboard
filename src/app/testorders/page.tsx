    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-sm">
          Look up a StockX order by number to see payout status, payout amount, and
          shipping/tracking URL. Requires StockX sign-in.
        </p>
        ...
        {result?.authRequired && (
          <div className="rounded-lg border border-amber-200 bg-amber-50 dark:border-amber-800 dark:bg-amber-900/30 p-4 text-amber-800 dark:text-amber-200">
            ...
            <a
              href="/api/stockx/auth?returnTo=/testorders"
        ...
        <p className="text-gray-500 dark:text-gray-400 text-xs">
          solesmarket.com/testorders — StockX order lookup (payout, shipping URL).
        </p>
      </div>
    </div>
  );
