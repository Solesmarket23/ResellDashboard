 ...
 * Usage: npx ts-node scripts/test-email-parser.js <email-file-path>
 */
...
import { OrderConfirmationParser } from '../src/lib/email/orderConfirmationParser';
...
function testEmailFile(filePath) {
  try {
    ...
    const orderInfo = parser.parseGmailApiMessage(mockGmailMessage);
